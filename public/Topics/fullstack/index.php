...
<section class="container subject">
    <h1> موضوعات فول استک <?= "($Name_Page Topic)" ?> </h1>
    <p>
        موضوعاتی که در موردفول استک (توسعه دهنده سمت کاربر و سمت سرور) نیاز دارید و در نقشه راه ها
    ...
    <section class="between">
        ...
        <h2>Topics</h2>
        <h2><a href="<?= site_url('road/' . $Name_Page) ?>"><?= $Name_Page ?></a></h2>
    </section>
    <section class="between">
        <hr class="between">
