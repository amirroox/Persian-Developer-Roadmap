<div class="content-dialog">
    <h1>Fetch API / Ajax (XHR)</h1>
    <h2>دریافت API و ایجکس</h2>
    <br>
    <p>
        ...
        (در همین رودمپ وقتی روی اجزا کلیک میکنید ، همین پنجره به صورت ایجکس باز میشه ، بئون رفرش یا ریدایرکت به صفحه دیگه!)
    </p>
    <br>
