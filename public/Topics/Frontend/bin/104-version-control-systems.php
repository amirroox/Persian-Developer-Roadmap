<div class="content-dialog">
    ...
    <h2>سیستم کنترل ورژن</h2>
    <br>
    <p>
        اگر برنامه نویس هستید و تاکنون با مفهومی به نام سیستم کنترل ورژن یا VCS آشنا نشده اید، بدانید که از یکی از مهمترین مفاهیم دنیای برنامه نویسی غافل هستید.
