<div class="content-dialog">
    ...
    <br>
    <p>
        pnpm را می‌توان نسخه‌ی سازگار با npm دانست اما استفاده‌ی بهینه‌ای از دیسک را علاوه‌بر سرعت بالای آن شاهد هستیم.
        <br>
        ...
        <br>
        pnpm یک مکانیسم کنترل دقیق دسترسی دارد، به این معنی که یک پکیج فقط می‌تواند به وابستگی‌هایی که در package.json تعریف شده دسترسی پیدا کند.
    </p>
    <br>
