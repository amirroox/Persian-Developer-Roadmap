<div class="content-dialog">
    ...
    <br>
    <p>
        این روزها بستر فریمورک ها بسیار گسترده شده است و انواع مختلفی در دنیای کامپیوتر رخ نشان داده اند. یکی از این فریمورک ها فریم ورک انگولار جی اس است که از توسعه زبان جاوا اسکریپت بدست آمده است.
        ...
        Angular یک چارچوب توسعه فرانت‌اند مبتنی بر کامپوننت است که بر اساس TypeScript ساخته شده است که شامل مجموعه‌ای از کتابخانه‌های به خوبی یکپارچه است که شامل ویژگی‌هایی مانند مسیریابی، مدیریت فرم‌ها، ارتباط مشتری-سرور و غیره است.
