<div class="content-dialog">
    ...
    <br>
    <p>
        مرورگر، اسمی است که به نرم افزارهایی اطلاق می‌شود که می‌توانید با آن ها وارد اینترنت شوید و از محتوایی که روی وب سایت های مختلف وجود دارد استفاده کنید. در واقع مرورگرها اطلاعات را از منابع مختلفی که در سرتاسر دنیا وجود دارد دریافت می‌کند و به شما اجازه می‌دهد به این دیتا دسترسی داشته باشید.
