<div class="content-dialog">
    ...
    <p>
        ...
        رویدادهای ارسال شده از سرور (SSE) فناوری است که به سرور وب اجازه می‌دهد تا داده‌ها را در زمان واقعی به مشتری ارسال کند. از یک اتصال HTTP برای ارسال جریانی از داده ها از سرور به مشتری استفاده می کند و مشتری می تواند به این رویدادها گوش دهد و هنگام دریافت آنها اقدام کند.
