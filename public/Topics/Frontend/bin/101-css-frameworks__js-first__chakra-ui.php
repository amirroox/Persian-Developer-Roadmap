<div class="content-dialog">
    ...
    <div class="row">
        <ul class="col-xs-12 col-md-6 links-reference right-link">
            <h4>منابع فارسی</h4>
            <li>
                <a href="https://hashdork.com/fa/chakra-ui-tutorial/">
                    آموزش رابط کاربری چاکرا برای مبتدیان
                </a>
            </li>
            <li>
                <a href="https://git.ir/udemy-build-an-e-commerce-app-with-react-and-chakra-ui-mern-2023/">
                    آموزش ساخت اپلیکیشن تجارت الکترونیک با ری اکت و Chakra UI MERN سال 2023 (انگلیسی - پولی)
                </a>
            </li>
