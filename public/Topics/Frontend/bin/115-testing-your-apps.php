<div class="content-dialog">
    ...
    <h2>تست نویسی برای برنامه ها</h2>
    <br>
    <p>
        قبل از اینکه برنامه خود را به کاربران تحویل دهید، باید مطمئن شوید که برنامه شما الزاماتی را که برای آن طراحی شده است برآورده می کند، و هیچ چیز عجیب و غریب و ناخواسته ای انجام نمی دهد . برای انجام این کار، ما برنامه های خود را به روش های مختلف "تست" می کنیم.
        تست نویسی ، یکی از بخش های جدانشدنی ساخت نرم افزاره ، با تست نویسی ، میتونیم تا حدودی ، اشکالات نرم افزاری که ساختیمو ، قبل از انتشار در مارکت ها یا تحویل دادن پروژه ، شناسایی کنیم ، این کار اگه به شکل اصولی انجام بشه ، هم از نظر هزینه ای ، هم از نظر کارایی ، خیلی به نفعمونه ، چون دیباگ کردن نرم افزار ، وقتی پروژه تحویل داده شده و در حال اجرا هستش به مراتب هزینه و زمان بیشتری بیشتری میطلبه ، همچنین اعتبار ما به عنوان برنامه نویس خدشه دار میکنه.
    </p>
    <br>
