<div class="content-dialog">
    ...
    <br>
    <p>
        این قسمت نیاز به توضیح خاصی نداره ولی یک از مسیر هایی که برای پیشرفت میتونید استفاده کنید یادگیری دسکتاپ
        اپلیکشن برای فرانته.
        حالا این یعنی چی ؟ یعنی شما سایتی که ساختید رو برای سیستم عامل های ویندوز ، لینوکس و ... آماده کنید (نه به صورت
        جدا ، بلکه به کمک فریمورک های مثل الکترون ، فلاتر و ...)
    </p>
    <br>
