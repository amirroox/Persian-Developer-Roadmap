...
<section class="container subject">
    <h1><?= "$Name_Page Developer" ?> (توسعه دهنده سمت سرور و سمت کاربر - فول استک) </h1>
    <p>راهنمای قدم به قدم برای تبدیل شدن به توسعه دهنده فول استک در سال <?= NOW_YEAR['solar'] ?></p>
    <br>
